    ...
    .map((building) => {
      ...
      return `
        <div>
          ...
          <br>
          <span class="building-cost">Cost: ${cost}</span>
          <br>
          <span class="building-mps">Muscle Per Second: ${building.mps}</span>
          <button 
            class="unlock-btn" 
